...
<body style="min-height: 800px !important;">
        ...
        <div class="ms_content_wrapper padder_top80">
            ...
            <div class="ms_featured_slider">
                ...
                <div class="ms_feature_slider swiper-container">
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                      <form method="POST" action="wallet_handle.php">
                        <div style="padding: 20px;background-color: #1b2039;border-radius: 4px;height: 270px">
                        <h2 style="font-size:  20px;">Add Balance Here</h2>
                        <div style="margin:10px 0px;border-bottom: solid 1px #343c69;"></div>

                        <!-- <div style="padding: 10px;"></div>
                        <div class="form-group">
                          <label style="color: #fff;">Select User</label>
 ...
 -->
                        <div class="form-group">
                          <label style="color: #fff;">No. of Token you need to Buy </label>
                            <input class="form-control" required="" type="number" min="100" value="100" name="amount" style="background-color: transparent;border:solid 1px #2e375f;border-radius: 0px;"> 
                            <input type="hidden" name="buyer" value="<?php echo $_SESSION['user']; ?>">
                        </div>
                        <div style="padding: 10px;"></div>
                        <button class="btn btn-lg" type="submit" style="height: 40px;width:100%;font-size: 18px;background-color: #2196f3;border-radius: 4px;color:#fff;">Add Credits to this Account</button>
