...
<body>
    ...
    <div class="ms_main_wrapper">        
                        ...
                        <div class="album_single_data">
                            ...
                            <div class="album_single_text">
                                ...
                                <div class="album_feature">
                                    <a href="#" class="album_date">COST | <?php echo $data['cost']; ?> SST</a>
                                ...
                                <div class="album_btn">
                                    ...
                                    if ($user>0) {
                                      echo '<button class="btn btn-lg" type="button" style="height: 40px;width:100%;font-size: 18px;background-color: #2a382a;border-radius: 4px;color:#5c6f5c;padding:10px;">Already Bought</button>';
                                    }else{

                                        ?>

                                        <a style="color:#fff;cursor:pointer" href="buy_song.php?track_id=<?php echo $trackId; ?>" class="ms_btn play_btn"><span class="play_all">
                        ...
                        <div style="padding: 20px;">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <h3 style="color: #fff;font-size: 20px;padding: 5px;font-weight: normal;"><span style="color:#3bc8e7;">Cost : </span> <?php echo $data['cost']; ?> SST</h3>
                                </div>
                                <div class="col-sm-8">
       ...
       <div id="myModal" class="modal fade" role="dialog">
          <div class="modal-dialog" style="z-index: 1500; filter: blur(0px) !important">
